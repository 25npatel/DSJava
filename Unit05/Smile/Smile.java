...
public class Smile {
    ...
    public static void draw(Graphics graph) {
        ...
        graph.fillArc(0,0,399,399,0,360);

        graph.setColor(Color.BLACK);
        graph.fillArc(99, 99, 50, 50, 0, 360);

        graph.setColor(Color.BLACK);
        graph.fillArc(249, 99, 50, 50, 0, 360);

        graph.setColor(Color.BLACK);
        graph.fillArc(75, 230, 250, 99, 0, 360);

        graph.setColor(Color.BLACK);
        graph.fillArc(199, 199, 10, 10, 0, 360);
       
        graph.setColor(Color.BLACK);
        graph.drawArc(0,0,399,399,0,360);
